...
#Updated list of friends ['Aisha_M', 'Esther', 'John', 'Kemi', 'Mary', 'Paul', 'Ruth', 'Zainab']
paulPosition = friends[5]
print(f"the position of {paulPosition} is at the 6 position")

normal = sorted(friends)
desesn = normal[::-1]
print(desesn)
